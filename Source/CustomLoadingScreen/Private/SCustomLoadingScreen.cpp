...
void SCustomLoadingScreen::Construct(const FArguments& InArgs, const FCustomLoadingScreenDescription& InScreenDescription)
{
	...
	[
		...
		[
			...
			[
				SNew(SDPIScaler)
				.DPIScale(this, &SCustomLoadingScreen::GetDPIScale)
				[
					SNew(SHorizontalBox)
...
float SCustomLoadingScreen::GetDPIScale() const
{
